...
for file in ['spots.php', 'submit-report.php', 'reports.php', 'log-catch.php', 'get-heat-list.php']:
    shutil.copy(f'../backend/api/{file}', f'deploy/public_html/api/')
# Note: config.php is generated by GitHub Actions workflow or must be created manually
# If you have a local config.prod.php, uncomment the next line:
...
print("   ⚠️  Remember: config.php must be created manually or via deployment workflow")

print("\n3. Exporting database...")
import pymysql
from dotenv import load_dotenv

# Load environment variables from data-pipeline/.env.docker or local .env
load_dotenv('../data-pipeline/.env.docker')
load_dotenv()  # Also try to load .env from current directory

MYSQL_CONFIG = {
    'host': os.getenv('DB_HOST', 'localhost'),
    'port': int(os.getenv('DB_PORT', 3306)),
    'user': os.getenv('DB_USER', 'fishing_user'),
    'password': os.getenv('DB_PASSWORD', 'fishing_password'),
    'database': os.getenv('DB_NAME', 'fishing_directory')
}
