...
const FISH_SVG = (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" fill="currentColor" class="listing-icon-fish">
...
export default function WhatEachListingIncludes() {
  return (
    <div class="retro-section">
      <h2>WHAT EACH LISTING INCLUDES</h2>

      <ul class="flex flex-column gap-md list-style-none">
        <li class="flex font-body-text font-size-md align-items-center gap-lg">
          <span class="listing-icon flex-shrink-0">{FISH_SVG}</span>
